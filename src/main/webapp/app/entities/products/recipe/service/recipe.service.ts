...
export class RecipeService {
  public resourceUrl = this.applicationConfigService.getEndpointFor('api/recipes', 'products');
  public resourceSearchUrl = this.applicationConfigService.getEndpointFor('api/_search/recipes', 'products');
