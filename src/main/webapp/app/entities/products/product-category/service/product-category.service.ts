...
export class ProductCategoryService {
  public resourceUrl = this.applicationConfigService.getEndpointFor('api/product-categories', 'products');
  public resourceSearchUrl = this.applicationConfigService.getEndpointFor('api/_search/product-categories', 'products');
