...
export class ProductService {
  public resourceUrl = this.applicationConfigService.getEndpointFor('api/products', 'products');
  public resourceSearchUrl = this.applicationConfigService.getEndpointFor('api/_search/products', 'products');
